...
namespace WebHost.IdSvr
{
    public static class UserServiceExtensions
    {
        public static void ConfigureUserService(this IdentityServerServiceFactory factory, string connString)
        {
            ...
            factory.Register(new Registration<AuthorizationCodeStore>());
            factory.Register(new Registration<TokenHandleStore>());
            factory.Register(new Registration<RefreshTokenStore>());
            factory.Register(new Registration<ConsentStore>());
